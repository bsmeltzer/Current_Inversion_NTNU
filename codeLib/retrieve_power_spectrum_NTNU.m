function [Spectrum] = retrieve_power_spectrum_NTNU(IMG_3D,dx,dy,dt,K_limits,W_limits)
...
%THIS FUNCTION HAS BEEN MODIFIED BY BENJAMIN SMELTZER, NORWEGIAN UNIVERSITY
%OF SCIENCE AND TECHNOLOGY (NTNU). THE MODIFICATIONS MAKE THE FUNCTION MORE
%GENERAL TO HANDLE 2D SPECTRA
...
if ~isnan(Norm)
    ...
    power_Spectrum = abs(Spectrum_raw).^2;
end
